<?php
/*
Plugin Name: Slack Live Chat and ChatGPT Chatbots
Plugin URI: http://www.socialintents.com
Description: Slack Chat lets you create AI Chatbots with ChatGPT trained on your content.  Then escalate chats to your agents in Slack. To get started: 1) Click the "Activate" link to the left of this description, 2) Go to your Slack Chat plugin Settings page, and click Get My API Key.
Version: 1.2.7
